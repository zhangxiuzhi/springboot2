			...
			'<div class="ui-widget-content plupload_container">' +
				/*'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("文件上传") + '</div>' +
						'<div class="plupload_header_text">' + _("添加文件后按开始按钮完成上传") + '</div>' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("可拖动文件添加.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add ui-btn btn-linear"><i class="far fa-plus"></i> ' + _("添加文件") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start ui-btn btn-blue"><i class="far fa-cloud-upload"></i> ' + _("开始上传") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_stop plupload_hidden ui-btn btn-white">'+_("停止上传") + '</a>&nbsp;' +
						'</div>' +
