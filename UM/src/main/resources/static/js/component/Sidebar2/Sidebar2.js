...
/**
 * Created by wzj on 2018/7/24.
 */

var Sidebar2 = function (_React$Component) {
	_inherits(Sidebar2, _React$Component);

	function Sidebar2(props) {
		_classCallCheck(this, Sidebar2);

		return _possibleConstructorReturn(this, (Sidebar2.__proto__ || Object.getPrototypeOf(Sidebar2)).call(this, props));
	}
