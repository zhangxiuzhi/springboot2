...
var UserTable = function (_React$Component) {
	...
	function UserTable(props) {
		...
		_this.thead = [{ dataField: "userName", dataName: "转出人名称", width: 110 },
			{ dataField: "phone", dataName: "转出人手机号", width: 120 },
			{ dataField: "points", dataName: "转出点卡数", width: 120 },
			{ dataField: "receiveUserName", dataName: "被转人名称", width: 120 },
			{ dataField: "receivePhone", dataName: "被转人手机号", width: 120 },
			{ dataField: "createTime", dataName: "转让时间", width: 120, dataFormat: function dataFormat(d) {
	...
	_createClass(UserTable, [{
		...
		value: function render() {
			...
			var options = {
				url: "/userPoint/transfer/listData", //数据请求url
				thead: this.thead, //表头
