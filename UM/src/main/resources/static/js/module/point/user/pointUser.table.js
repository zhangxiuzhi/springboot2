...
var UserTable = function (_React$Component) {
	...
	function UserTable(props) {
		...
		_this.thead = [{ dataField: "userName", dataName: "用户名", width: 110 }, { dataField: "merchantName", dataName: "商户名称", width: 110 }, { dataField: "scanTime", dataName: "扫码时间", width: 150, dataFormat: function dataFormat(d) {
				return jbsframe.formatDateTime(d);
			} }, { dataField: "totalPrice", dataName: "消费点数", width: 120 }, { dataField: "totalPoints", dataName: "剩余点数", width: 120 }];
		_this.state = {
			data: [],
			page: 1,
			size: 10,
	...
	_createClass(UserTable, [{
		...
		value: function render() {
			...
			var options = {
				url: "/userPoint/listData?detailSource=1", //数据请求url
				thead: this.thead, //表头
