...
var UserTable = function (_React$Component) {
	...
	function UserTable(props) {
		...
		_this.thead = [{ dataField: "id", dataName: "操作", width: 90, dataFormat: formatOperation },
...
function formatOperation(id) {
	var html = "";
	html += "<a href='/goods/edit/" + id + "' class='ui-link-icon fal fa-pencil-alt ' data-tabname='" + id + "' data-tabtype='edit' data-tabtitle='商品种类修改(" + id + ")' title='商品种类修改'></a>";
	html += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    html += "<button type='button' class='ui-link-icon far fa-trash-alt' onclick='goodsTypeDelete(" + id + ")'></button>";
	return html;
}

// 删除
function goodsTypeDelete(id) {
