...
var UserTable = function (_React$Component) {
	...
	function UserTable(props) {
		...
		_this.thead = [
			{ dataField: "userName", dataName: "用户名", width: 110 },
			{ dataField: "merchantName", dataName: "商户名称", width: 110 },
			{ dataField: "goodsName", dataName: "商品名称", width: 110 },
            { dataField: "unitPrice", dataName: "消费点数", width: 120 },
            { dataField: "totalPrice", dataName: "剩余点数", width: 120 },
			{ dataField: "scanTime", dataName: "扫码时间", width: 150, dataFormat: function dataFormat(d) {
